...
var VSwagger = { render: function render() {
        var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "api" }, [_vm.error ? _c('span', [_vm._v(_vm._s(_vm.error))]) : _vm._e(), _vm._v(" "), _vm.api ? _c('section', [_c('div', { staticClass: "header", on: { "click": function click($event) {
                    _vm.open = !_vm.open;
                } } }, [_c('span', { staticClass: "title" }, [_vm._v(_vm._s(_vm.api.info.title))]), _vm._v(" "), _c('span', { staticClass: "host" }, [_vm._v(_vm._s(_vm.api.host))])]), _vm._v(" "), _c('div', { directives: [{ name: "show", rawName: "v-show", value: _vm.isOpen, expression: "isOpen" }], staticClass: "table" }, _vm._l(_vm.tags, function (tag, index) {
            return _c('section', { key: index }, [_c('h3', [_vm._v(_vm._s(tag.name))]), _vm._v(" "), _c('p', [_vm._v(_vm._s(tag.description))]), _vm._v(" "), _vm._l(_vm.paths[tag.name], function (resources, path) {
                return _c('div', { key: path }, [_c('h4', [_vm._v(_vm._s(path))]), _vm._v(" "), _vm._t("default"), _vm._v(" "), _vm._l(resources, function (item, method) {
                    return _c('request', { key: method, attrs: { "method": method, "url": path, "description": item.summary, "headers": item.headers, "path": item.parameters, "params": item.parameters, "body": item.responses } });
                })], 2);
            })], 2);
        }))]) : _vm._e()]);
