(function (global, factory) {
            ...
            var ParamsTable = { render: function render() {
                    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "parameters" }, [_c('p', { staticClass: "description" }, [_vm._v(_vm._s(_vm.resource.description))]), _vm._v(" "), _c('div', { staticClass: "section-header" }, [_vm._m(0), _vm._v(" "), !_vm.execute ? _c('div', { staticClass: "try-out" }, [_c('button', { staticClass: "btn", on: { "click": function click($event) {
                                _vm.execute = true;
                ...
                methods: {
                    ...
                    getData: function getData() {
                        ...
                        var body = this.dataParameters.filter(function (it) {
            ...
            var request = { render: function render() {
                    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { class: ['request', _vm.method.toLowerCase(), _vm.isOpened] }, [_c('div', { class: ['request-item'], on: { "click": function click($event) {
                                _vm.open = !_vm.open;
                            } } }, [_c('span', { staticClass: "method" }, [_vm._v(_vm._s(_vm.method))]), _vm._v(" "), _c('span', { staticClass: "path" }, [_vm._v(_vm._s(_vm.url))]), _vm._v(" "), _c('span', { staticClass: "description" }, [_vm._v(_vm._s(_vm.description))])]), _vm._v(" "), _c('params-table', { directives: [{ name: "show", rawName: "v-show", value: _vm.open, expression: "open" }], attrs: { "params": _vm.sourceList, "resource": _vm.resource } })], 1);
                ...
                computed: {
                    ...
                    sourceList: function sourceList() {
                        ...
                        var sourceList = [].concat(this.dataPath, this.dataHeaders, this.dataBody, this.dataQuery);
                ...
                methods: {
                    ...
                    parseBody: function parseBody() {
                        ...
                        var body = this.params.filter(function (param) {
                    ...
                    parseQuery: function parseQuery(params) {
                        ...
                        var query = this.params.filter(function (param) {
                            return param.in == "query";
                        });

                        return query.map(function (key) {
            ...
            var VSwagger = { render: function render() {
                    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "api" }, [_vm.error ? _c('span', [_vm._v(_vm._s(_vm.error))]) : _vm._e(), _vm._v(" "), _vm.api ? _c('section', [_c('div', { staticClass: "header", on: { "click": function click($event) {
                                _vm.open = !_vm.open;
                            } } }, [_c('span', { staticClass: "title" }, [_vm._v(_vm._s(_vm.api.info.title))]), _vm._v(" "), _c('span', { staticClass: "host" }, [_vm._v(_vm._s(_vm.api.host))])]), _vm._v(" "), _c('div', { directives: [{ name: "show", rawName: "v-show", value: _vm.isOpen, expression: "isOpen" }], staticClass: "table" }, [_c('section', { staticClass: "header" }, [_c('div', { staticClass: "left" }, [_c('label', { attrs: { "for": "scheme" } }, [_vm._v("Schemes")]), _vm._v(" "), _c('select', { directives: [{ name: "model", rawName: "v-model", value: _vm.scheme, expression: "scheme" }], staticClass: "select", attrs: { "id": "scheme" }, on: { "change": function change($event) {
                                var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
                                    return o.selected;
                                }).map(function (o) {
                                    var val = "_value" in o ? o._value : o.value;return val;
                                });_vm.scheme = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
                            } } }, _vm._l(_vm.api.schemes, function (scheme, index) {
                        return _c('option', { key: index, domProps: { "value": scheme } }, [_vm._v(_vm._s(scheme))]);
                    }))]), _vm._v(" "), _c('div', { staticClass: "right" }, [_c('label', { attrs: { "for": "authorization" } }, [_vm._v("Authorization")]), _vm._v(" "), _c('select', { directives: [{ name: "model", rawName: "v-model", value: _vm.authorization, expression: "authorization" }], staticClass: "select", attrs: { "id": "authorization" }, on: { "change": function change($event) {
                                var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
                                    return o.selected;
                                }).map(function (o) {
                                    var val = "_value" in o ? o._value : o.value;return val;
                ...
                mounted: function mounted() {
                    ...
                    SwaggerParser.validate(this.spec, function (err, api) {
                        if (err) {
                            ...
                            var pathKeys = Object.keys(api.paths);
                            ...
                            if (api.tags && api.tags.length > 0) {
                                ...
                                _this.tags.forEach(function (tag) {
                                    ...
                                    Object.values(api.paths).map(function (resource, path) {

                                        Object.values(resource).forEach(function (method, k) {

                                            var mObj = {};

                                            Object.keys(resource).forEach(function (m) {
                                        ...
                                        _this.paths[tag.name] = obj;
                                    });
                                });
                            } else {
                                _this.paths['default'] = api.paths;
                            }
                        }
                    });
                },
